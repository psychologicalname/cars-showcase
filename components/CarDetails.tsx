                ...
                <Dialog as='div' onClose={closeModal} className='relative z-10'>
                    ...
                    >
                        <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl shadow-xl bg-white text-left transition-all flex flex-col gap-5 p-6'>
                            <button
                                className='absolute top-2 right-2 z-10 bg-primary-blue-100 rounded-full w-fit p-2'
                                type='button'
                                onClick={closeModal}
                            >
                                <Image 
                            ...
                            <div className='flex-1 flex flex-col gap-3'>
                                ...
                                <div className='flex gap-3'>
                                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car, '29')} fill priority alt='car model' className='translate-y-1 object-contain' />
                                    </div>
                                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car, '33')} fill priority alt='car model' className='translate-y-5 object-contain' />
                                    </div>
                                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car, '13')} fill priority alt='car model' className='translate-y-2 object-contain' />
                                    </div>
                                </div>
                            </div>
